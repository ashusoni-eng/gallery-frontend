...
export default function ManageImagesPage() {
  ...
  return (
    <div className="space-y-4">
      <h2 className="text-xl font-semibold text-pretty">Manage Images</h2>

      <div className="rounded-xl border bg-card shadow-sm">
        <div className="border-b p-6">
          <div className="text-base font-semibold">Upload Images</div>
        ...
        <div className="space-y-4 p-6">
            ...
            <div className="flex items-center gap-2">
              ...
              {loadingCategories ? (
                <select
                  ...
                  className="h-9 rounded-md border border-input bg-transparent px-3 text-sm outline-none shadow-xs focus-visible:ring-2 focus-visible:ring-ring/50"
                  disabled
                >
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
            {previews.map((p) => (
              <div key={p.url} className="overflow-hidden rounded-lg border bg-card shadow-sm">
      ...
      {/* <div className="rounded-xl border bg-card shadow-sm">
        <div className="border-b p-6">
          ...
          <div className="text-sm text-muted-foreground">Uploaded images.</div>
        </div>
        <div className="p-6">
          {loadingGallery ? (
            <div className="text-center text-muted-foreground">Loading gallery...</div>
          ) : gallery.length === 0 ? (
            <div className="text-center text-muted-foreground">No images in the gallery.</div>
          ) : (
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
